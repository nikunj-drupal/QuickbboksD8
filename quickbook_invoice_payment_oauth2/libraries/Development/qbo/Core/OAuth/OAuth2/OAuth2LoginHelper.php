...
require_once(PATH_SDK_ROOT . 'Core/HttpClients/CurlHttpClient.php');
require_once(PATH_SDK_ROOT . 'Core/CoreConstants.php');
require_once(PATH_SDK_ROOT . 'Core/OAuth/OAuth1/OAuth1.php');
...
class OAuth2LoginHelper
{
    ...
    public function getAccessToken(){
       $this->oauth2AccessToken = variable_get('access_token','');
    ...
    public function refreshToken(){
       $refreshToken = variable_get('refresh_token','');

 ...
 */
require_once(PATH_SDK_ROOT . 'XSD2PHP/src/com/mikebevz/xsd2php/Common.php');
require_once(PATH_SDK_ROOT . 'XSD2PHP/src/com/mikebevz/xsd2php/NullLogger.php');
...
class Php2Xml extends Common {
    ...
    private function parseObjectValue($obj, $element) {
        ...
        if(isset($classDocs['xmlNamespace'])) {

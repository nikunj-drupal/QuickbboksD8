...
require_once(PATH_SDK_ROOT . 'Core/Http/Serialization/XmlObjectSerializer.php');
...
require_once(PATH_SDK_ROOT . 'Core/Http/Compression/CompressionFormat.php');
require_once(PATH_SDK_ROOT . 'Core/Http/Compression/GZipCompressor.php');
require_once(PATH_SDK_ROOT . 'Core/Http/Compression/DeflateCompressor.php');
require_once(PATH_SDK_ROOT . 'Diagnostics/TraceLevel.php');
require_once(PATH_SDK_ROOT . 'Exception/IdsException.php');
require_once(PATH_SDK_ROOT . 'Diagnostics/LogRequestsToDisk.php');
/**
 * Helper class.
 */
 class CoreHelper
